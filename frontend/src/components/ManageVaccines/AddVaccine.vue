<template>
    <div id="add-vaccine" :class="[ (visible === 'true') ? 'add-margin' : 'rm-margin']">
        <div class="container">

            <div class="">
                <h1 class="card-title mt-3 text-center" style="color: rgb(48, 20, 10);">Thêm Vaccine</h1>
                    ...
                    <b-form @submit="onSubmit">
                        ...
                        <div class="form-group input-group">
                            ...
                            <b-form-spinbutton id="sb-inline" style="width: 140px;"
                                v-model="vaccine.interval_between_doses" inline>
                            </b-form-spinbutton>
                        ...
                        <article class="card-body" style="max-width: 150px;" id="card3">
                            <div class="form-group">
                                <b-button type="submit" class="btn btn-primary btn-block"
                                    style="background-color: #007bff;border-color: #007bff;"> Thêm </b-button>
                            </div> <!-- form-group// -->
                        </article>
    ...
    export default {
        data() {
            return {
                ...
                vaccine: {
                    ...
                    interval_between_doses: null,
                    starting_time_of_doses: null,
                    price: 0
                }
            }
        },
        methods: {
            onSubmit(event) {
                ...
                this.$axios.post('http://localhost:8000/add-vaccine', this.vaccine)
                    .then(res => {
                        if (res.status === 200) {
